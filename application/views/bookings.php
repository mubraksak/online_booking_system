                    ...
                    <div class="brand text-center">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <a href="#hotel_booking" class="btn btn-primary">book a Hotel/Hostel now</a>
                                </h3>
                            </div>
                            <div class="col-md-4">
                                <h1>Spring water booking</h1>
                                <a href="<?php echo base_url(); ?>booking/spring_booking/4/" class="btn btn-primary">book for Spring now</a>
                                </h3>
                            </div>
                            <div class="col-md-4">
                                <h1>Safari tour booking</h1>
                                <a href="<?php echo base_url(); ?>booking/safari_booking/5/" class="btn btn-primary">book for safiri tour now</a>
                                </h3>
                            </div>
                        </div>
    ...
    <div class="main main-raised">
        <div class="container">
            <div class="section text-center">
                <div class="row justify-content-center" id="hotel_booking">
                    <?php foreach ($products as $product) : ?>
                        <div class="col-sm-12 col-md-4 col-lg-3">
                            <div class="card col-12">
							<?php if($product->product_category == 'reservation'): ?>
                                <a href="<?php echo base_url(); ?>Booking/book/<?php echo $product->product_id ?>/<?php echo $user->user_id; ?>">
                                    <img class="img-raised" src="<?php echo base_url() ?>assets/img/yankari/yankariaf.jpg" alt="" width="100%" height="140">
								</a>
								<?php elseif($product->product_category == 'safari tour'): ?>
								<a href="<?php echo base_url(); ?>Booking/book/<?php echo $product->product_id ?>/<?php echo $user->user_id; ?>">
									<img class="img-raised" src="<?php echo base_url() ?>assets/img/yankari/yankaricave.jpg" alt="" width="100%" height="140">
								</a>
								<?php else : ?>
								<a href="<?php echo base_url(); ?>Booking/book/<?php echo $product->product_id ?>/<?php echo $user->user_id; ?>">
