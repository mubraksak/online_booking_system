      ...
      <?php echo form_open('Admin/update_product/'. $product->product_id, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
        ...
        <h3 class="title">edit product</h3>
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="text" class="form-control" name="vat" value="<?php echo $product->vat; ?>" placeholder="VAT">
            </div>
            <div class="col-md-6">
              <input type="text" class="form-control" name="room_number" value="<?php echo $product->room_number; ?>" placeholder="room Number">
            </div>
            <div class="col-md-6">
            </div>
            <br><br>
