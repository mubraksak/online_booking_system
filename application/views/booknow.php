                ...
                <form action="<?php echo base_url(); ?>Booking/checkout/<?php echo $product->product_id; ?>/<?php echo $user->user_id; ?>" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="col-10 offset-1 col-lg-8 offset-lg-2 card container">
                        <div class="row">
                            ...
                            <img class="col-sm-12 col-lg-3" src="<?php echo base_url() ?>assets/img/yankari/yankariaf.jpg" alt="" width="100%" height="150">
							<?php elseif($product->product_category == 'safari tour'): ?>
							<img class="col-sm-12 col-lg-3" src="<?php echo base_url() ?>assets/img/yankari/yankaricave.jpg" alt="" width="100%" height="150">
							<?php else : ?>
